            ...
            <div className="flex flex-wrap justify-between items-center">
                ...
                <div className="flex items-center gap-3">
                    <div className="rounded border border-[#D9D9D9] flex items-center gap-[6px]">
                        <p className="flex gap-2 py-[10px] px-4 items-center font-normal text-[14px] text-[#4D4D4D]">Sort <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
